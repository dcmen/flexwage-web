...
$(document).ready(function() {
    $('#theme-loader').fadeOut(2000, function() {
        $(this).remove();
    });
    $(function() {
...
'<ul>'+
    '<li>' +
        '<a href="http://html.codedthemes.com/Adminty/doc" target="_blank" rel="noopener" class="btn btn-primary btn-block m-r-15 m-t-5 m-b-10">Online Documentation</a>' +
    '</li>' +
    '<li class="text-center">' +
        '<span class="text-center f-18 m-t-15 m-b-15 d-block">Thank you for sharing !</span>' +
        '<a href="#!" target="_blank" rel="noopener" class="btn btn-facebook soc-icon m-b-20"><i class="feather icon-facebook"></i></a>' +
        '<a href="#!" target="_blank" rel="noopener" class="btn btn-twitter soc-icon m-l-20 m-b-20"><i class="feather icon-twitter"></i></a>' +
    '</li>' +
'</ul>'+
'');